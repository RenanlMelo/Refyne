            ...
            <div>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2 relative">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <Mail className="h-5 w-5 text-zinc-500 group-focus-within:text-[#CC97FF] transition-colors" />
                    </div>
                    <input
                      type="email"
                      value={email}
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-zinc-950/50 border border-white/5 rounded-xl text-white placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-[#CC97FF]/50 focus:border-[#CC97FF]/50 transition-all hover:bg-zinc-900/50"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2 relative">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <Lock className="h-5 w-5 text-zinc-500 group-focus-within:text-[#CC97FF] transition-colors" />
                    </div>
                    <input
                      ...
                      required
                      placeholder="••••••••"
                      className="w-full pl-10 pr-12 py-2.5 bg-zinc-950/50 border border-white/5 rounded-xl text-white placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-[#CC97FF]/50 focus:border-[#CC97FF]/50 transition-all hover:bg-zinc-900/50"
                    />
                    <button
                      type="button"
                ...
                <div className={`space-y-5 overflow-hidden transition-all duration-500 ease-in-out ${isLogin ? 'max-h-0 opacity-0' : 'max-h-[100px] opacity-100'}`}>
                  <div className="space-y-2 relative">
