...
import {
  ...
  StartupApplication,
} from "@/hooks/useStartupApplications";
    ...
    <div className={styles.appCard}>
      <div className={styles.row}>
        ...
        <div className={styles.statusCol}>
          <span
            className={`${styles.statusBadge} ${app.status.toLowerCase() === "approved" ? styles.approved : app.status.toLowerCase() === "closed" ? styles.closed : styles.pending}`}
          >
            {app.status}
          </span>
