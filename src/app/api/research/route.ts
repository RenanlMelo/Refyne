...
const GOOGLE_FORM_URL =
  "https://docs.google.com/forms/d/e/1FAIpQLScSCpKopYfFnLcTxqeZn_FTJ4qBjg-ytmGk0jdEdcJCL1wgWw/formResponse";
...
export async function POST(req: NextRequest) {
  ...
  if (body.variant === "startup") {
    ...
    formData.append("entry.1063195008", String(body.companyName || ""));
    ...
    formData.append(
      "entry.920917370",
      "Consinto com a retenção e o processamento das informações fornecidas neste formulário exclusivamente para fins de inteligência de mercado, pesquisas educacionais e desenvolvimento da plataforma REFYNE.",
    );
